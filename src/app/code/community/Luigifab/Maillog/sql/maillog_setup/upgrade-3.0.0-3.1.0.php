...
try {
	...
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN encoded_mail_recipients varchar(255) NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN encoded_mail_subject    varchar(255) NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN mail_recipients         varchar(255) NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN mail_subject            varchar(255) NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN mail_body               longtext     NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN mail_header             text         NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN mail_parameters         text         NULL DEFAULT NULL');
	$this->run('ALTER TABLE '.$table.' MODIFY COLUMN mail_parts              longblob     NULL DEFAULT NULL');
