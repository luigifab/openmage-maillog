...
class Luigifab_Maillog_Block_Adminhtml_Config_Customer extends Mage_Adminhtml_Block_System_Config_Form_Field {
	...
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
		...
		if (true) {
			...
			$select = $read->select()
				...
				->where('table_name = ?', $resource->getTableName('customer_entity'));
			...
			return '<span id="'.$element->getHtmlId().'">'.Mage::getResourceModel('customer/customer_collection')->getSize().'</span>';
		}
	}
}